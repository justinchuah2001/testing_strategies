...
The attendee can only view the events for a maximum of 5 years in past and next five years in future and also for each event, there is a limit of 20 attendees, this will be limit in function **check\_attendee\_limit**.
